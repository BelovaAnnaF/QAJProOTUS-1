...
public class EventsPage extends AbsBasePage {
  ...
  private final String eventsCardElementLocator = "//div[@class='dod_new-event-content']";
  ...
  public void eventsFilter() {
    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
    driver.findElement(By.xpath("//div[@class = 'dod_new-events-dropdown js-dod_new_events-dropdown']/div/span"))
            .click();
    driver.findElement(By.xpath("//div[@class='dod_new-events-dropdown js-dod_new_events-dropdown dod_new-events-dropdown_opened']"
                    + "/div[@class='dod_new-events-dropdown__list js-dod_new_events-dropdown']/a[@title ='Открытый вебинар']"))
            .click();
